...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Sign in · Virtual Lookbook" },
      { name: "description", content: "Sign in to Virtual Lookbook with email or Google to access your private AI styling studio, closet, and lookbooks." },
      { property: "og:title", content: "Sign in · Virtual Lookbook" },
      { property: "og:description", content: "Sign in to access your private AI styling studio, closet, lookbooks, and moodboards." },
      { property: "og:url", content: "https://virtuallookbookpro.lovable.app/login" },
    ],
    links: [{ rel: "canonical", href: "https://virtuallookbookpro.lovable.app/login" }],
  }),
  component: LoginPage,
});
