...
export const Route = createFileRoute("/_authenticated/collections")({
  head: () => ({
    meta: [
      { title: "Collections · Virtual Lookbook" },
      { name: "description", content: "Group your saved looks into themed collections — capsule wardrobes, seasonal edits, or shoot-day storyboards." },
      { property: "og:title", content: "Collections · Virtual Lookbook" },
      { property: "og:description", content: "Themed collections of your saved AI-styled looks." },
      { property: "og:url", content: "https://virtuallookbookpro.lovable.app/collections" },
    ],
    links: [{ rel: "canonical", href: "https://virtuallookbookpro.lovable.app/collections" }],
  }),
            ...
            <div key={c.id} className="glass rounded-3xl overflow-hidden">
              <div className="aspect-[16/9] bg-dreamy relative">
                ...
                <div className="absolute bottom-3 left-3 right-3 flex justify-between items-end">
                  ...
                  <button aria-label={`Delete collection ${c.name}`} onClick={() => removeCollection(c.id)} className="h-7 w-7 grid place-items-center rounded-full bg-background/70"><Trash2 className="h-3 w-3 text-destructive" /></button>
                </div>
              </div>
              <div className="p-4">
